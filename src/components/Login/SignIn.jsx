            ...
            <div className={styles.block_signUp}>
                <div className={styles.block_two}>
                    ...
                    <form onSubmit={handleSignUp} className={styles.form_signUp}>
                        ...
                        <input type="text" value={login} placeholder='Логин' onChange={(e) => handleLogin(e)} className={`${styles.input4} ${styles.inp}`} />
                        <input type={text ? 'password' : 'text'} value={password} placeholder='Пароль' onChange={(e) => handlePassword(e)} className={styles.input5}/>
                        <img src={iconPassword ? "https://cdn-icons-png.flaticon.com/512/159/159604.png" : "https://cdn-icons-png.flaticon.com/512/7615/7615155.png"} alt="#" className={styles.eyeForPasswor} onClick={handleClick}/>

                        <button type='submit' className={styles.btn}>АВТОРИЗАЦИЯ</button>
                    </form>
                </div>
            </div>
        </div>
